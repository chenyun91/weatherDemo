 ...
 * https://www.jianshu.com/p/cc8420f4b2d8
 */
...
public class ShadowLayout extends LinearLayout {
    ...
    private void dealAttrs(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null) {
            ...
            shadowRadius =
                    typedArray.getDimension(R.styleable.ShadowLayout_shadow_radius, shadowRadius);
            shadowBlur =
                    typedArray.getDimension(R.styleable.ShadowLayout_shadow_blur, shadowBlur);
            shadowDx = typedArray.getDimension(R.styleable.ShadowLayout_shadow_dx, shadowDx);
            shadowDy = typedArray.getDimension(R.styleable.ShadowLayout_shadow_dy, shadowDy);
            typedArray.recycle();
        }
    }
